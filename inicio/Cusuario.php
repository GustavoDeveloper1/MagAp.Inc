...
<body>
    ...
    <header class="masthead" style="background-image: url('img/cadastro.jpg')">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="page-heading">
                        <h1>Usuário</h1>
                        <span class="subheading">Cadastrar Usuário</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form action="" method="POST" id="contactForm" novalidate>
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>Usuário</label>
                            <input type="text" class="form-control" placeholder="Usuário" id="name" required data-validation-required-message="Preecnha este campo!">
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>Senha</label>
                            <input type="password" class="form-control" placeholder="Senha" id="email" required data-validation-required-message="Preecnha este campo!">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <br>
